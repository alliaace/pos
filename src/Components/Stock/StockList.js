...
const headCells = [
    ...
    { id: 'Buy_Date', numeric: false, disablePadding: false, label: 'Buy Date' },
    { id: 'Product_Per_Carton', numeric: false, disablePadding: false, label: 'Product Per Carton' },
    { id: 'Quantity', numeric: false, disablePadding: false, label: 'Quantity' },
    { id: 'Buy_Price', numeric: false, disablePadding: false, label: 'Buy Price' },
    { id: 'Sale_Price', numeric: false, disablePadding: false, label: 'Sale Price' },
...
export default function EnhancedTable() {
    ...
    const handleSelectAllClick = (event) => {
        if (event.target.checked) {
            const newSelecteds = rows.map((n) => n.Product_Name);
